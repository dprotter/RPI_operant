...
default_setup_dict = {'vole':'000','day':1, 'experiment':'Autoshape_contingent',
...
key_values_def = {'num_rounds':'number of rounds', 
                  ...
                  'ITI':'time between rounds, after either press or lever timeout',
...
def run_script(setup_dictionary = None):
    ...
    for i in range(1, key_values['num_rounds']+1,1):
        ...
        while time.time() - round_start < key_values['round_time'] and press == False:
        ...
        iti_start = time.time()
        approx_time = key_values['ITI'] - (time.time() - iti_start)
...
if __name__ == '__main__':
    ...
    if test_run.lower() in ['y', 'yes']:
        ...
        key_values['ITI'] = 5
        day = input('Which autoshape_contingent training day is this? (for training)\n')
        day = int(day)
        ...
        day = input('Which autoshape_contingent training day is this? (starts at day 1)\n')
        day = int(day)
